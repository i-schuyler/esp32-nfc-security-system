...
5. **Hardware & Wiring Contract** (`Hardware_and_Wiring_v1_0.md`, `Wiring_Instructions_DevKitV1_v1_0.md`, `Wiring_Instructions_ESP32S3_N32R16v_v1_0.md`)
...
6) Hardware & Wiring  
   ...
   - `Wiring_Instructions_ESP32S3_N32R16v_v1_0.md`
...
8) Web UI Spec (includes Setup Wizard + Factory Restore)  
   ...
   - Board-aware pin policy: Section 8 "Board-aware pin policy (Setup Wizard contract)" in `Web_UI_Spec_v1_0.md`
